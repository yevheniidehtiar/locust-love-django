...
class Project(models.Model):
    ...
    department = models.ForeignKey(
        Department, related_name="projects", on_delete=models.CASCADE
    )
...
class Document(models.Model):
    ...
    uploaded_by = models.ForeignKey(
        Employee, related_name="uploaded_documents", on_delete=models.CASCADE
    )
    upload_date = models.DateTimeField(auto_now_add=True)
    file_type = models.CharField(max_length=20)
    content = models.BinaryField(
        blank=True, null=True
    )  # Large binary field for document content
    description = models.TextField(blank=True)
...
class Task(models.Model):
    ...
    created_by = models.ForeignKey(
        Employee, related_name="created_tasks", on_delete=models.CASCADE
    )
